...
public class WeightsModel {
    ...
    public WeightsModel(double bias, double weightOfAddress, double weightOfTimeToStation, double weightOfStructureAndDesign,
	    double weightOfTotalUsableArea, double weightOfNumberYears, double weightOfFloor,
	    double weightOfKindsOfHouse, double weightOfFeaturesAndEquipment) {
	super();
	this.bias = bias;
	...
	return "WeightsModel [" + bias + ", " + weightOfAddress + ", " + weightOfTimeToStation + ", " + weightOfStructureAndDesign + ", "
		+ weightOfTotalUsableArea + ", " + weightOfNumberYears + ", " + weightOfFloor + ", "
		+ weightOfKindsOfHouse + ", " + weightOfFeaturesAndEquipment + "]";
    }
}
